...
Public Class designate_external
    ...
    Private Sub designate_external_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        reload("SELECT * FROM tbl_designateexternal", dgv_designation)
    ...
    Private Sub cmb_department_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmb_department.SelectedIndexChanged
        reload("SELECT * FROM tbl_designateexternal WHERE location = '" & cmb_department.Text & "'", dgv_designation)
    End Sub
    ...
    Public Sub FilterData(valueToSearch As String)
        ...
        strcon.Close()
        strcon.Open()
        Dim searchquery As String = "SELECT * FROM tbl_designateexternal WHERE CONCAT(serial_number,unit_id,model,brand_name.unit_type,assigned_to,employee_no) LIKE '%" & txtbx_search.Text & "%'"
    ...
    Private Sub dgv_designation_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv_designation.CellContentClick
        txtb_designation.Text = "External"
