...
Public Class stock_storage
    ...
    Private Sub stock_storage_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        depreciateitems()
        strcon.Close()
        reload("SELECT * FROM tbl_stockstorage", dgv_stockunit)
        FilterData("")
        ...
        Try
            ...
            cmd3.CommandText = "SELECT * FROM tbl_storagedrivetype"
            cmd3.Connection = strcon

            daa3.SelectCommand = cmd3
            daa3.Fill(dtt3)

            cmb_storagetype.DataSource = dtt3
            cmb_storagetype.ValueMember = "storagetype_id"
            cmb_storagetype.DisplayMember = "storage_type"
            cmb_storagetype.Text = ""
    ...
    Private Sub Btn_Add2_Click(sender As Object, e As EventArgs) Handles Btn_Add2.Click
        ...
        storage = Convert.ToInt32(txtb_storagesize.Text)
        ...
        ElseIf storage > 100000 Or storage < 60 Then
    ...
    Public Sub CMBPlaceHolder()
        cmb_brand.Text = "Please Select"
        cmb_storagetype.Text = "Please Select"
    End Sub
    ...
    Public Sub getunitcondition()
        Try
            strcon.Open()
            cmd.CommandText = "SELECT unit_condition from tbl_storagecondition WHERE serial_number = '" & txtbx_serialno.Text & "'"
            cmd.Connection = strcon
        ...
        Try
            ...
            Else
                ...
                If dr.HasRows Then
                    ...
                    cmb_storagetype.Text = dr.GetValue(4).ToString()
                    ...
                    Else
                        ...
                        cmdd.CommandText = "SELECT depreciation_value FROM tbl_stockstoragevalue WHERE serial_number = '" & txtbx_serialno.Text & "'"
    ...
    Public Sub AddUnit()
        ...
        Try
            ...
            Else
                ...
                GetDateDiff()
                strcon.Close()
                create("INSERT INTO tbl_stockstorage (unit_id,serial_number,brand_name,model,type,size,purchased_value,date_purchased) VALUES ('" & lbl_unitid.Text & "','" & txtbx_addunit.Text & "', '" & cmb_brand.Text & "','" & txtbx_model.Text & "','" & cmb_storagetype.Text & "','" & txtb_storagesize.Text & "','" & txtb_purchasedvalue.Text & "','" & dtp_purchased.Text & "')")
                strcon.Close()
                ...
                strcon.Close()
                create("INSERT INTO tbl_allstocks (unit_id,serial_number,brand_name,model,unit_type,unit_condition,availability,date_added) VALUES ('" & lbl_unitid.Text & "','" & txtbx_addunit.Text & "', '" & cmb_brand.Text & "','" & txtbx_model.Text & "','Storage drive','Working','Available','" & lbl_datetoday.Text & "')")
                strcon.Close()
                create("INSERT INTO tbl_storagecondition (unit_id,serial_number,brand,model,unit_condition) VALUES ('" & lbl_unitid.Text & "','" & txtbx_addunit.Text & "','" & cmb_brand.Text & "','" & txtbx_model.Text & "', 'Working')")
                strcon.Close()
                create("INSERT INTO tbl_inventorystorage (unit_id,serial_number,brand_name,model,unit_type,unit_condition) VALUES ('" & lbl_unitid.Text & "','" & txtbx_addunit.Text & "','" & cmb_brand.Text & "','" & txtbx_model.Text & "','Storage drive','Working')")
                strcon.Close()
                MessageBox.Show("Storage drive added sucessfully!", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information)
                reload("SELECT * FROM tbl_stockstorage", dgv_stockunit)
                strcon.Close()
            End If
        Catch ex As Exception
    ...
    Private Sub UpdateUnit()
        Try
            ...
            GetDateDiff()
            strcon.Close()
            updates("UPDATE tbl_stockstorage SET brand_name = '" & cmb_brand.Text & "', model = '" & txtbx_model.Text & "', type = '" & cmb_storagetype.Text & "', size = '" & txtb_storagesize.Text & "', purchased_value = '" & txtb_purchasedvalue.Text & "', date_purchased = '" & dtp_purchased.Text & "' WHERE serial_number = '" & txtbx_serialno.Text & "'")
            ...
            updates("UPDATE tbl_storagecondition SET brand = '" & cmb_brand.Text & "', model = '" & txtbx_model.Text & "', unit_condition = '" & cmb_unitcondition.Text & "' WHERE serial_number = '" & txtbx_serialno.Text & "'")
            updates("UPDATE tbl_stockstoragevalue SET brand_name = '" & cmb_brand.Text & "', model = '" & txtbx_model.Text & "', purchased_value = '" & txtb_purchasedvalue.Text & "' , depreciation_value = '" & txtb_depreciatedvalue.Text & "', date_purchased = '" & dtp_purchased.Text & "' WHERE serial_number = '" & txtbx_serialno.Text & "'")
            strcon.Close()
    ...
    Public Sub FilterData(valueToSearch As String)
        ...
        If cmb_searchfilter.Text = "SERIAL NO." Then
            Dim searchquery As String = "SELECT * FROM tbl_stockstorage WHERE CONCAT(serial_number) LIKE '%" & txtbx_search.Text & "%'"
        ...
        ElseIf cmb_searchfilter.Text = "BRAND" Then
            Dim searchquery As String = "SELECT * FROM tbl_stockstorage WHERE CONCAT(brand_name) LIKE '%" & txtbx_search.Text & "%'"
            Dim command As New MySqlCommand(searchquery, strcon)
            Dim adapter As New MySqlDataAdapter(command)
            Dim table As New DataTable
        ...
        ElseIf cmb_searchfilter.Text = "MODEL" Then
            Dim searchquery As String = "SELECT * FROM tbl_stockstorage WHERE CONCAT(model) LIKE '%" & txtbx_search.Text & "%'"
            Dim command As New MySqlCommand(searchquery, strcon)
            Dim adapter As New MySqlDataAdapter(command)
            Dim table As New DataTable
    ...
    Private Sub cmb_storagetype_KeyPress(ByVal sender As Object, e As KeyPressEventArgs) Handles cmb_storagetype.KeyPress
        e.Handled = True
    End Sub
